...
<Steps>
    ...
    2. Clone the ESP-IDF repository.
        ...
        ```sh
        mkdir -p ~/dev/embedded/frameworks/ESP-IDF/v5.1.4
        cd ~/dev/embedded/frameworks/ESP-IDF/v5.1.4
    ...
    3. Set up the tools.
        ...
        <Tabs>
            <TabItem label="Bash and Zsh">
                ```sh
                cd esp-idf
                export IDF_TOOLS_PATH="$HOME/dev/embedded/frameworks/ESP-IDF/v5.1.4/espressif"
            ...
            <TabItem label="fish">
                ```sh
                cd esp-idf
                set -x IDF_TOOLS_PATH "$HOME/dev/embedded/frameworks/ESP-IDF/v5.1.4/espressif"
...
<Tabs syncKey="PROJ_PROFILE">
    <TabItem label="Debug">
        ```sh
        idf.py -B build/debug -DLPRD_DEBUG=ON build
        ```
    </TabItem>
...
<Tabs syncKey="PROJ_PROFILE">
    <TabItem label="Debug">
        ```sh
        idf.py -B build/debug -DLPRD_DEBUG=ON flash
        ```
    </TabItem>
    <TabItem label="Release">
        ```sh
        idf.py -B build/release -DLPRD_DEBUG=OFF flash
        ```
    </TabItem>
</Tabs>
...
<Tabs syncKey="PROJ_PROFILE">
    <TabItem label="Debug">
        ```sh
        idf.py -B build/debug -DLPRD_DEBUG=ON monitor
        ```
    </TabItem>
    <TabItem label="Release">
        ```sh
        idf.py -B build/release -DLPRD_DEBUG=OFF monitor
        ```
    </TabItem>
</Tabs>
...
<Tabs syncKey="PROJ_PROFILE">
    <TabItem label="Debug">
        ```sh
        idf.py -B build/debug -DLPRD_DEBUG=ON fullclean
        ```
    </TabItem>
    <TabItem label="Release">
        ```sh
        idf.py -B build/release -DLPRD_DEBUG=OFF fullclean
        ```
    </TabItem>
</Tabs>
