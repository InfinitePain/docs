...
<Steps>
    1. Configure a containerization system like [Podman](https://wiki.archlinux.org/title/Podman) or Docker.
...
First, we need to clone the repository that container the necessary scripts and files to work with the board.
